...
バージョン1.3.6では、記事面の「この記事の著者」カードをカバー画像付きのリッチなプロフィールカード（T.M | AIに仕事を奪われるエンジニア）へ刷新しました。PICK UPおよび最新記事の整列・余白最適化、白い記事ヘッダー、680px本文カラム、目次・関連記事、PCサイドバー開閉、Codex招待ページも同梱しています。
