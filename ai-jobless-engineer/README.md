...
バージョン1.3.7では、記事面の著者プロフィールカードで名前がカバー画像に被らないようレイアウトを最適化し、左サイドバー下部のプロフィール情報もT.Mプロフィールに統一しました。PICK UPおよび最新記事の整列・余白最適化、白い記事ヘッダー、680px本文カラム、目次・関連記事、PCサイドバー開閉、Codex招待ページも同梱しています。
